...
A collection of loudspeaker layout presets for the [IEM MultiEncoder](https://plugins.iem.at/docs/plugindescriptions/#multiencoder) plug-in from the [IEM Plug-in Suite](https://plugins.iem.at/). Covers industry-standard multichannel formats, mathematical spherical distributions, and special loudspeaker arrays.
...
Loudspeaker positions follow the APL [Virtuoso](https://apl-hud.com/product/virtuoso/) loudspeaker layouts [specification](https://apl-hud.com/wp-content/uploads/2023/03/APL-Virtuoso-Loudspeaker-Layouts.pdf).

## Usage

1. Install the [IEM Plug-in Suite](https://plugins.iem.at/)
2. Open **MultiEncoder** in your DAW
